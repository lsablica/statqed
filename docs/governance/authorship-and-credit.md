...
Method-pack papers should use contribution statements and include substantive contributors according to venue norms. Release metadata records machine-readable contributions. Agents are tools, not authors, but their model/tool provenance is retained for reproducibility.
