...
SQ-0001 established the constitutional boundaries. SQ-0002 selected reviewed toolchain recommendations but initialized no production project and accepted no Draft RFC semantics. SQ-0003 and SQ-0004 completed the separately reviewed Lean and Rust production bootstraps. SQ-0005 accepted the bounded data-free RFC-0001 profile after independent prototype and conformance review. SQ-0006 completed the separately reviewed data-free fixture schema. SQ-0007 completed the independently reviewed test-only theorem registry and lock v0. The ledger has no active task; SQ-0008, SQ-0011, SQ-0013, SQ-0014, and SQ-0015 are independently READY and unstarted.
...
SQ-0003 through SQ-0007 are DONE after separately reviewed proof-backend,
reference-workspace, encoding-profile, data-free schema, and test-only Registry
foundations. The computed READY set is SQ-0008, SQ-0011, SQ-0013, SQ-0014,
and SQ-0015. No successor is active.
...
- [x] SQ-0007 theorem registry and lock v0 — claimed `IN_PROGRESS` on 2026-08-11T21:56:01+02:00 from reviewed main `6148589f10ee58a8cba58f959aec25c6f5207e8d` in `/tmp/statqed-sq0007-theorem-registry` on `agent/SQ-0007-theorem-registry`. Launch contract SHA-256: `2be5ff48bd9d6d17d6b62de6ca0a536f90288ab453ce06819f692b92d8efe0ef`. After three separately reviewed predecessor repairs and repeated hostile-input review, distinct formal/trust, counterexample, and integration reviewers approved exact scientific candidate `0b08a2e2d87a4bd55c38da5fd4cd5f5dea103c15`. RFC-0005 and byte-matched ADR-0007 are Accepted, SQ-0007 is DONE, and every successor remains unclaimed.
- [x] SQ-0007 fail-closed integration blocker — the inherited SQ-0003/SQ-0005 failures were preserved, reproduced, and repaired only through separately reviewed predecessor maintenance. Historical reports remain historical while live policy now checks every tracked module and only explicitly owned subtrees.
- [x] SQ-0007 predecessor regression fixtures — the successor-state-dependent SQ-0005/SQ-0006 simulations were made branch-neutral in separate predecessor maintenance; all 100 SQ-0005 and 57 SQ-0006 tests pass with the real Registry files present.
...
- The first SQ-0007 implementation review exposed composition rather than theorem-registry semantics: SQ-0005 still compared complete live Lean/backend trees with its historical snapshot, the SQ-0003 committed report was both historical and treated as future-global coverage, and two SQ-0006 ownership fixtures inherited ambient task state. Versioned live policies and source-derived all-module checks are required; rewriting historical evidence or filtering out Registry modules would be unsound.
- Cross-filesystem cache moves may copy rather than rename. The first post-merge relocation filled the shared filesystem with an incomplete duplicate; deleting only the two task-created cache copies recovered approximately 7.4 GiB without touching tracked evidence, shared toolchains, or user-owned `.codex/` state.
...
- 2026-08-12: Kept the preserved SQ-0007 implementation at honest `IN_REVIEW` while a separate maintenance candidate versioned SQ-0005 and SQ-0006 live evidence, retained their prior manifests and scientific digests, and added project-wide live Lean declaration/axiom observation plus fresh replay for every tracked StatQED module. The maintenance ledger itself remains DONE=6, READY=6, active=none, BLOCKED=48.
- 2026-08-12: Authorized maintenance PR #21 merged the exact reviewed head normally as `e6e6fcf5a4dc58037be506b67eb25deee9298979`. All normal and exact-main evidence/trust runs passed; SQ-0007 then resumed by merging that verified predecessor commit without rewriting prototype history.
