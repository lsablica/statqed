...
- [ ] Compositional predecessor-evidence maintenance — started 2026-08-12 from `6148589f10ee58a8cba58f959aec25c6f5207e8d` on `maintenance/compositional-predecessor-evidence` after the isolated SQ-0007 review reproduced fail-closed predecessor overbinding. The candidate retains SQ-0005 v1/v2 and SQ-0006 v1/v2 history, introduces separately versioned v3 live policies, preserves the SQ-0003 historical axiom report, adds deterministic all-module axiom and fresh-kernel coverage, and makes lifecycle fixtures state-explicit. All successors remain READY and unclaimed on the maintenance branch; merge still requires distinct evidence, formal, adversarial, CI, and integration approval.
- [ ] SQ-0007 predecessor repair integrated — exact independently approved maintenance head `51d45e83a05dfc951052f68d6bf7dcefc28d3ec6` merged normally as `e6e6fcf5a4dc58037be506b67eb25deee9298979`; five normal main workflows plus exact-main Serialization, Schema, and Lean trust dispatches passed before this normal merge resumed the preserved SQ-0007 branch.
